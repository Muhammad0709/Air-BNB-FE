                ...
                <Box sx={{ width: '100%', maxWidth: { xs: '100%', lg: '500px' }, mx: 'auto', px: { xs: 0, sm: 1 } }}>
                  ...
                  >
                      ...
                      >
                        ...
                        <Typography component="span" sx={{ fontWeight: 700, color: '#111827', fontSize: { xs: 14, md: 16 }, letterSpacing: 0.5 }}>
                      ...
                      >
                        <Box sx={{ textAlign: 'center' }}>
                          <Typography sx={{ fontSize: { xs: 11, md: 12 }, color: '#6B7280', fontWeight: 500 }}>
                            Check-in
                          </Typography>
                          <Typography sx={{ fontSize: { xs: 12, md: 13 }, color: formData.checkin ? '#111827' : '#9CA3AF', fontWeight: 600, mt: 0.5 }}>
                        ...
                        <Box sx={{ textAlign: 'center' }}>
                          ...
                          <Typography sx={{ fontSize: { xs: 12, md: 13 }, color: formData.checkout ? '#111827' : '#9CA3AF', fontWeight: 600, mt: 0.5 }}>
