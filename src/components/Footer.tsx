        ...
        <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: '1.2fr 1fr 1.2fr' }, gap: { xs: 4, md: 6 }, alignItems: 'start' }}>
          ...
          <Box>
            ...
            <Stack spacing={1.5} sx={{ color: '#C7CAD3' }}>
              <Box component={Link} to="/" sx={{ color: 'inherit', textDecoration: 'none', '&:hover': { color: '#FF8C75' } }}>Home</Box>
              <Box component={Link} to="/listing" sx={{ color: 'inherit', textDecoration: 'none', '&:hover': { color: '#FF8C75' } }}>Listing page</Box>
              <Box component={Link} to="/contact" sx={{ color: 'inherit', textDecoration: 'none', '&:hover': { color: '#FF8C75' } }}>Contact Us</Box>
              <Box component={Link} to="/terms-of-service" sx={{ color: 'inherit', textDecoration: 'none', '&:hover': { color: '#FF8C75' } }}>Terms of Service</Box>
            </Stack>
          </Box>
